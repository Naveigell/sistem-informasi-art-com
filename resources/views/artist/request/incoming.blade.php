        ...
        <div class="card text-center">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('artist.requests.index', ["type" => \App\Enums\RequestType::INCOMING]) }}">Incoming Request</a>
                    </li>
                    <li class="nav-item">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>Belum Lunas</td>
                    <td>
                        <a href="{{ route('artist.requests.reviews.edit', [1, 1]) }}" class="btn btn-primary">Review</a>
